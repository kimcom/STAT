...
//		rowNum:10000000,
		...
		$("#" + subgrid_table_id).jqGrid({
			url: "../api/jqgrid3?action=doc_check_info&sc.CheckID=" + row_id + "&f1=GoodID&f2=Article&f3=Name&f4=Quantity&f5=PriceBase&f6=PriceDiscount&f7=DiscountPercent&f8=Price&f9=Summa",
			datatype: "json",
...
//	});
	...
	$('#myTab a').click(function (e) {
		...
		if (this.id == 'a_tab_history') {
			$("#grid1").jqGrid('setGridParam', {url: "../api/jqgrid3?action=discountcards_history&cl.CardID=" + $("#cardid").val() + "&grouping=cl.CheckID&f1=CheckID&f2=DT_check&f3=ClientName&f4=TypePaymentName&f5=SumFull&f6=SumDiscount&f7=Sum", page: 1});
			$("#grid1").trigger('reloadGrid');
		}
	});

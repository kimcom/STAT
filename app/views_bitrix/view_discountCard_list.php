...
// Creating grid1
	$("#grid1").jqGrid({
		sortable: true,
		url:"../api/jqgrid3?action=discountCards_list&f1=CardID&f2=Name&f3=Phone&f4=DateOfIssue&f5=DateOfCancellation&f6=ClientID&f7=PercentOfDiscount&f8=AmountOfBuying&f9=SummaAmount",	
		datatype: "json",
		height:'auto',
...
//	    }
	...
	$("#grid1").navButtonAdd('#grid1_toppager', {
		...
		onClickButton: function () {
		    ...
		    if (id != '')
				window.location = "../api/card.getinfo?cardid=" + id+"&auth=bc3939d76f543f3efe46be026f4ddfdd";
		}
    });

...
// Creating grid1
	$("#grid1").jqGrid({
		sortable: true,
	    url:"../engine/jqgrid3?action=cancel_base&f1=BaseID&f2=BaseName&f3=NoShow&UserID=<?php echo $_SESSION['UserID']; ?>",
		datatype: "json",
		height:'auto',
		colNames:['Код','Основание','Статус'],
		colModel:[
			{name:'BaseID',		index:'BaseID',		width: 60, align:"center", sorttype:"text", search:true, editable: true, key: true},
			{name:'BaseName',	index:'BaseName', 	width:300, align:"left",   sorttype:"text", search:true, editable: true, edittype:"text"},
		...
		viewrecords: true,
		toppager: true,
		caption: "Список оснований для списаний",
		pager: '#pgrid1',
		editurl: "../engine/cancel_base_save",
		grouping: true
	});

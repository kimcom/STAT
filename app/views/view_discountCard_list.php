...
// Creating grid1
	$("#grid1").jqGrid({
		...
		colModel:[
			...
			{name:'Family',            index:'Family',               width: 220, align:"left",sorttype:"text",  search:true},
            {name:'Phone1',            index:'Phone1',              width: 100, align: "left", sorttype: "number", search: true},
			...
			{name:'с_NameShort',       index:'c.NameShort',         width: 60, align:"center", sorttype:"text", search:true},

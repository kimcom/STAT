...
// Creating grid1
    $("#grid1").jqGrid({
        sortable: true,
        url:"../engine/jqgrid3?action=check_list&cl.ClientID=2010&grouping=cl.CheckId&f1=CheckID&f2=CheckStatus&f3=TypePayment&f4=TypeCheck&f5=CreateDateTime&f6=City&f7=ClientName&f8=SumBase&f9=SumDiscount&f10=Sum&f11=CardID",
        datatype: "json",
        height:'auto',

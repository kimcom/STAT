...
//	var data = [
//		{id: 'rep1', text: 'Расчет общей конверсии за период по точкам'}, 
//		{id: 'rep4', text: 'Расчет общей конверсии за период по дням'}, 
//		{id: 'rep2', text: 'Расчет конверсии по дням (сортировка по точкам)'}, 
//		{id: 'rep3', text: 'Расчет конверсии по дням (сортировка по дням)'}, 
//	];
...
//		if ($("#select_report").select2('val') == '') {
//			$("#dialog").css('background-color', 'linear-gradient(to bottom, #f7dcdb 0%, #c12e2a 100%)');
//			$("#dialog>#text").html('Необходимо выбрать вид отчета!');
//			$("#dialog").dialog("open");
//			return;
//		}
		...
		$.post("../reports/report"+reportID+"_data" +
				...
				function (json) {
					...
					$('#div_report').find('tr.row_data').popover({container: 'body', title:'Информация', trigger: 'hover', delay: {show: 200, hide: 200}, html: true})
...
<div class="container-fluid center">
	<ul id="myTab" class="nav nav-tabs floatL active hidden-print" role="tablist">
		...
		<li><a id="a_tab_report" href="#tab_report" role="tab" data-toggle="tab">Отчет "Планирование"</a></li>
	</ul>
	<div class="floatL">

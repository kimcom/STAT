...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="count">'+$.ui.multiselect.locale.itemsCount+': 0</span><a href="#" class="remove-all">'+$.ui.multiselect.locale.removeAll+'</a></div>').appendTo(this.selectedContainer);
	...
	_updateCount: function() {
		...
		this.selectedContainer.find('span.count').text($.ui.multiselect.locale.itemsCount+": "+this.count);
	},
